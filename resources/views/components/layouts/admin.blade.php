    ...
    <div class="flex h-full">
        ...
        <aside class="w-64 bg-white border-r border-slate-100 flex-shrink-0 flex flex-col">
            ...
            <nav class="flex-1 p-4 space-y-1">
                ...
                <a href="{{ route('admin.subscription-settings.edit') }}" wire:navigate
                   class="{{ request()->routeIs('admin.subscription-settings.*') ? 'flex items-center gap-3 px-3 py-2.5 bg-brand-50 text-brand-700 rounded-xl font-semibold' : 'flex items-center gap-3 px-3 py-2.5 text-slate-500 hover:bg-slate-50 hover:text-slate-700 rounded-xl' }}">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
