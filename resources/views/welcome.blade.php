<x-layouts.app>
    ...
    {{-- Advertisement Slot --}}
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12" aria-label="Iklan">
            ...
            <div class="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <h2 class="mt-1 text-xl font-bold text-slate-700">Promosikan tempat atau layananmu di Tempatin</h2>
                        <p class="mt-2 max-w-2xl text-sm leading-relaxed text-slate-500">
                            Area ini disiapkan untuk banner sponsor, promo mitra, atau kampanye iklan yang ingin ditampilkan di halaman utama.
                        </p>
                    </div>
                </div>
